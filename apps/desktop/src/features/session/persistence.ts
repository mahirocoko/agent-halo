import { DELETED_SESSIONS_STORAGE_KEY, DISMISSED_SESSIONS_STORAGE_KEY, SESSION_EVENTS_STORAGE_KEY } from './constants'
import { isSessionEventRegistry, normalizeSessionEventRegistry } from './event-registry'
import type { DeletedSessionRegistry, DismissedSessionRegistry, SessionEventRegistry } from './types'
...
const readTimestampRegistry = (key: string, allowLegacyArray: boolean): Record<string, number> => {
  try {
