...
import type { IUsePomodoroResult } from '../pomodoro/use-pomodoro'
import { StopwatchPanel } from '../stopwatch/components'
import type { IUseStopwatchResult } from '../stopwatch/use-stopwatch'
  ...
  return (
    <div className="focus-tools-container">
      <div className="focus-tools-tray" data-testid="focus-tools-tray" ref={layout.trayRef}>
        <section
          className="focus-tool-card focus-tool-card-pomodoro halo-tab-surface halo-surface-lavender"
          aria-label="Pomodoro"
        ...
        <section
          className="focus-tool-card focus-tool-card-stopwatch halo-tab-surface halo-surface-mint"
        ...
        <section
          className="focus-tool-card focus-tool-card-move halo-tab-surface halo-surface-sand"
          aria-label="Move"
